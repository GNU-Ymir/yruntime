 ...
 */
_yrt_slice_ _yrt_type_typeinfo_name (_yrt_slice_ className);

/**
 * \return the name of the vtable symbol of a class from the class name
 */
_yrt_slice_ _yrt_type_vtable_name (_yrt_slice_ className);
 ...
 */
_yrt_slice_ _yrt_type_constructor_no_param_name (_yrt_slice_ className);
