 ...
 */
_yrt_slice_t _yrt_i_type_typeinfo_name (_yrt_slice_t className);

/**
 * \return the name of the vtable symbol of a class from the class name
 */
_yrt_slice_t _yrt_i_type_vtable_name (_yrt_slice_t className);
 ...
 */
_yrt_slice_t _yrt_i_type_constructor_no_param_name (_yrt_slice_t className);
