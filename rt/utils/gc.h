 ...
 *
 * Called by _yrt_init_runtime for the main thread, and by _yrt_i_thread_create for every thread
...
/**
 * Unregister the calling thread's static TLS block, undoing _yrt_i_gc_add_tls_roots
 * */
