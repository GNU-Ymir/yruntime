...
/**
 * Create a _yrt_slice_t pointer to data
 */
 ...
 * Create a _yrt_slice_t pointer to data
 */
_yrt_slice_t _yrt_i_str_create_len (const char * data, unsigned long len);

/**
 * Create a copy of the data
 */
_yrt_slice_t _yrt_i_str_copy_len (const char *data, unsigned long len);
